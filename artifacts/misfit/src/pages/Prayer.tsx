    ...
    <>
      ...
      <div className="min-h-screen bg-dark">
        ...
        <div className="max-w-6xl mx-auto p-8">
          ...
          {/* Prayer Stories Gallery */}
          <div className="mt-12 mb-12">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold text-gold mb-4">Stories of Faith</h2>
              <p className="text-text-secondary">Real people, real prayers, real transformation.</p>
            </div>
            <ImageGallery
              images={[
